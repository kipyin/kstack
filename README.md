...
1. In the app's `.cursor/install.sh`, after product setup, clone GitHub kstack and copy skills. Replace `<project>` with a name [install.sh](install.sh) accepts: `global`, `lighthouse`, or `lightmind`.
